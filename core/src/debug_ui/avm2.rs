...
use crate::avm2::{
    Activation, ArrayStorage, ClassObject, Error, Namespace, Object, TObject as _, Value, ValueEnum,
};
...
impl ValueWidget {
    fn new<'gc>(context: &mut UpdateContext<'gc>, value: Value<'gc>) -> Self {
        match value.normalize().unpack() {
            ValueEnum::Undefined => ValueWidget::Other(Cow::Borrowed("Undefined")),
            ValueEnum::Null => ValueWidget::Other(Cow::Borrowed("Null")),
            ValueEnum::Bool(value) => ValueWidget::Other(Cow::Owned(value.to_string())),
            ValueEnum::Number(value) => ValueWidget::Other(Cow::Owned(value.to_string())),
            ValueEnum::Integer(value) => ValueWidget::Other(Cow::Owned(value.to_string())),
            ValueEnum::String(value) => ValueWidget::String(value.to_string()),
            ValueEnum::Object(value) => ValueWidget::Object(
