...
use super::{
    ...
    content_element_object::ContentElementObjectData,
    element_format_object::ElementFormatObjectData,
    font_description_object::FontDescriptionObjectData,
    context3d_object::Context3DObjectData, date_object::DateObjectData,
    dictionary_object::DictionaryObjectData, dispatch_object::DispatchObjectData,
    domain_object::DomainObjectData, error_object::ErrorObjectData, event_object::EventObjectData,
    file_reference_object::FileReferenceObjectData, font_object::FontObjectData,
    ...
    condition_object::ConditionObjectData, message_channel_object::MessageChannelObjectData,
    mutex_object::MutexObjectData, namespace_object::NamespaceObjectData,
    ...
    stylesheet_object::StyleSheetObjectData, textformat_object::TextFormatObjectData,
    texture_object::TextureObjectData, vector_object::VectorObjectData,
    vertex_buffer_3d_object::VertexBuffer3DObjectData,
...
define_variants!(
    ...
    MutexObject => MutexObjectData<'gc>,
    ConditionObject => ConditionObjectData<'gc>,
